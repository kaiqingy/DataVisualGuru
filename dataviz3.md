...
My friends' feedbacks are really helpful in terms of overall layout design and color choice. They also provides me some further improvement such as adding animation in my graph like gapminder did. I think it is a great idea to present and I can use different groups to show the time lines. Unfortunately I was not able to create my embed the code in Github, so I found a demo that illustrate my future steps: 
